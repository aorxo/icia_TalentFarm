...
<html>
	...
	<body>
		...
		<div id="writebtn"><button onclick="popon()">리뷰 작성</button></div>
		<div id="reviewphoto">
		...
		<div id="pop">
			<form id="sendForm" action="reviewwrite" method="post">
				<img src = "resources/img/x.png" width="15" style="margin-top : 10px; margin-left:573px; position:fixed;" id="writeClose"/>
	...
	//글쓰기 창 닫기
	 $('#close').click(function() {
		...
		<c:forEach items="${reviewList}" var="list">
			img += "<img class='img' id='"+${list.board_idx}+"' width='200px' src='resources/upload/"+"${list.newFile}"+"'/>";
		</c:forEach>
